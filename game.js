...
class Game {
  ...
  constructor() {
    ...
    this.round = parseInt(document.getElementById("level").innerHTML);

    this.currentColor = document.getElementsByClassName("glowstage" + round);
    ...
    Matter.Events.on(this.engine, "collisionStart", (event) => {
      for (let pair of event.pairs) {
        ...
        if (
          ...
          if (
            pair.bodyA.parent.label == "Ground" ||
